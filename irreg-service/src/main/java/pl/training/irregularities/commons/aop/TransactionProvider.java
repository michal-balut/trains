package pl.training.irregularities.commons.aop;
...
import static pl.training.irregularities.commons.aop.Annotations.findAnnotation;
...
public class TransactionProvider {
    ...
    @Around("@annotation(pl.training.irregularities.commons.Atomic) || within(@pl.training.irregularities.commons.Atomic *)")
